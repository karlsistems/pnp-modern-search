...
var FilterControlsWebComponent = /** @class */ (function (_super) {
    ...
    FilterControlsWebComponent.prototype.connectedCallback = function () {
        return __awaiter(this, void 0, void 0, function () {
            var showApplyButton, clearButtonText, applyButtonText, props;
            return __generator(this, function (_a) {
                showApplyButton = this.getAttribute('show-apply-button') !== 'false';
                clearButtonText = this.getAttribute('clear-button-text') || 'Clear All';
                applyButtonText = this.getAttribute('apply-button-text') || 'Apply Filters';
                props = {
